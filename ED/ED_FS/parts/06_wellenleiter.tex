...
\begin{formelreihe}
  ...
  \parbox[t]{\linewidth}{%
    \formelblock{Dämpfung — Leiterverluste $[\mathrm{Np/m}]$}{%
    ...
    \infoblock{Niedrige $f$: Leiterverluste dominieren;
      ...
      Np $\to$ dB: $a=8{,}686\,\mathrm{dB}\cdot\alpha l$.}} &
  \parbox[t]{\linewidth}{%
...
\begin{formelreihe}
  ...
  \parbox[t]{\linewidth}{%
    ...
    \formelblock{Wanddämpfung H$_{10}$ $[\mathrm{Np/m}]$}{%
...
\begin{formelreihe}
  ...
  \parbox[t]{\linewidth}{%
    \merkblock{EMV-Merksatz}{%
      \begin{aligned}
        &\text{Jeder geschl.\ leitf.\ Hohlraum}\\[-0.1em]
        &\text{hat Resonanzfrequenzen}
      \end{aligned}}\\[0.2em]%
...
\begin{formelreihe}
  \parbox[t]{\linewidth}{%
    \formelblock{Leitungsbeläge (längenbezogen)}{%
      \begin{aligned}
        &R'\,[\tfrac{\Omega}{\mathrm m}],\;L'\,[\tfrac{\mathrm H}{\mathrm m}]\ (\text{längs})\\[0.05em]
        &G'\,[\tfrac{\mathrm S}{\mathrm m}],\;C'\,[\tfrac{\mathrm F}{\mathrm m}]\ (\text{quer})
      \end{aligned}}\\[0.2em]%
    \merkblock[cKap7]{Leitungswellenwiderstand}{%
