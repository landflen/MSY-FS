...
{\large\textbf{Vollversion} \textendash{} \emph{alle} 55 Aufgaben
aus \emph{allen} 11 Altklausuren (SoSe 2021 bis WiSe 2025/26). Das ist die
Version zum Ausdrucken und Mitnehmen.}\par\vspace{6mm}
...
{\sffamily\color{Grau} alle 11 Klausuren \textendash{} 31 verschiedene Teilaufgaben ausgeschrieben, 10 Wiederholungen als Verweis}\par\vspace{2mm}
...
\gs{$d$} und \gs{$\varepsilon_r$} zugleich: minimale Dämpfung \emph{und} vorgegebenes $Z_L$ ($Z_L = 77\,\Omega/\sqrt{\varepsilon_r}$) & \textbf{S.\,\pageref{tf:WiSe24y25:1:1}} \textcolor{Grau}{WiSe 24/25, 1.} \\
...
Umkehrung: welcher \gs{Durchmesser $D$} ist nötig, damit die Dämpfung ein Budget einhält? & \textbf{S.\,\pageref{tf:SoSe24:1:1}} \textcolor{Grau}{SoSe 24, 1.} \\
...
Schirmdämpfung: in welchem \gs{Frequenzbereich} wird eine Vorgabe eingehalten? \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} hier der Bereich, in dem die Dämpfung \emph{größer} als die Vorgabe ist -- SoSe 21 fragt den Bereich darunter} & \textbf{S.\,\pageref{tf:SoSe24:1:3}} \textcolor{Grau}{SoSe 24, 3.} \\
...
Schirmdämpfung: welche \gs{Wandstärke $w$} ist nötig? \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} Grundfall} & \textbf{S.\,\pageref{tf:WiSe22x23:1:4}} \textcolor{Grau}{WiSe 22/23, 4.} \\
Schirmdämpfung: welche \gs{Wandstärke $w$} ist nötig? \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} hier für einen ganzen Frequenzbereich -- schlechtester Fall ist die kleinste Frequenz} & \textbf{S.\,\pageref{tf:WiSe24y25:1:4}} \textcolor{Grau}{WiSe 24/25, 4.} \\
...
Stehwellen: \gs{Frequenz} aus dem Abstand von Spannungsmaximum und -minimum & \textbf{S.\,\pageref{tf:WiSe25y26:1:2}} \textcolor{Grau}{WiSe 25/26, 2.} \\
Stehwellen: \gs{Betrag des Reflexionsfaktors} aus $U_{max}$ und $U_{min}$ & \textbf{S.\,\pageref{tf:WiSe25y26:1:3}} \textcolor{Grau}{WiSe 25/26, 3.} \\
\gs{$Z_L$} (und daraus \gs{$d$}) aus dem Reflexionsfaktor & \textbf{S.\,\pageref{tf:WiSe25y26:1:4}} \textcolor{Grau}{WiSe 25/26, 4.} \\
\gs{Eingespeiste} und \gs{im Verbraucher verbrauchte Leistung} bei Fehlanpassung & \textbf{S.\,\pageref{tf:WiSe25y26:1:5}} \textcolor{Grau}{WiSe 25/26, 5.} \\
\hline\end{tabularx}\normalsize
\par\vspace{5mm}
...
\item Wie lange braucht ein Signal / Impuls durch das $l$ lange Kabel? ($v_{ph}=c_0/\sqrt{\varepsilon_r}$) \textcolor{Grau}{\itshape(beim Hohlleiter schon gefragt: SoSe 24 A2.3)}\\[0.6mm] {\footnotesize\color{A1Farbe}$\rightarrow$ $t=l/v_{ph}$ mit $v_{ph}=c_0/\sqrt{\varepsilon_r}$ -- beim Koax (TEM-Welle) keine Dispersion, also \emph{keine} Gruppengeschwindigkeit nötig}
...
\par\vspace{6mm}
\Needspace*{190.9mm}
\marke{\color{A1Farbe}A1 \textendash{} SoSe 2024}
\phantomsection\label{auf:SoSe24:1}
\aufgabenkopf{SoSe 2024 \textendash{} Aufgabe 1}{18 Punkte}{A1Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 682.50bp 39.00bp 106.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (208.78bp,-1.26bp) rectangle (241.00bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (94.92bp,-12.18bp) rectangle (120.68bp,-22.26bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (24.50bp,-34.02bp) rectangle (43.68bp,-44.10bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (78.12bp,-34.02bp) rectangle (102.48bp,-44.10bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\includegraphics[page=2,trim={52.00bp 490.50bp 39.00bp 192.50bp},clip,scale=0.620]{A_SoSe24.pdf}
\par\vspace{1.2mm}
\phantomsection\label{tf:SoSe24:1:1}
\par\vspace{1.6mm}
\Needspace*{50mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 391.50bp 39.00bp 423.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (200.93bp,-12.18bp) rectangle (222.77bp,-22.26bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (57.12bp,-1.26bp) rectangle (130.20bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (128.52bp,-1.26bp) rectangle (136.92bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A1Farbe}
\vspace{1.2mm}
\includegraphics[page=1,trim={52.00bp 578.50bp 39.00bp 130.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\par\vspace{1.6mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 341.50bp 39.00bp 487.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (209.16bp,-0.42bp) rectangle (246.49bp,-10.50bp);
\end{tikzpicture}
\par
\phantomsection\label{tf:SoSe24:1:2}
\Needspace*{18mm}
\verweis{A1Farbe}{2.}{Eindeutigkeit: welches \gs{$\varepsilon_r$} darf das Dielektrikum maximal haben?}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{SoSe 2021, Aufgabe 1.1}, \textbf{Seite \pageref{tf:SoSe21:1:1}}}
\phantomsection\label{tf:SoSe24:1:3}
\par\vspace{1.6mm}
\Needspace*{49mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 214.50bp 39.00bp 589.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (178.92bp,-0.42bp) rectangle (223.44bp,-10.50bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (333.20bp,-11.34bp) rectangle (354.48bp,-21.42bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (66.64bp,-11.34bp) rectangle (127.12bp,-21.42bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A1Farbe}
\vspace{1.2mm}
\includegraphics[page=1,trim={52.00bp 330.50bp 39.00bp 497.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=1,trim={52.00bp 214.50bp 39.00bp 538.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=1,trim={52.00bp 175.50bp 39.00bp 653.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\par\vspace{6mm}
\Needspace*{185.6mm}
\marke{\color{A1Farbe}A1 \textendash{} WiSe 2024/25}
\phantomsection\label{auf:WiSe24y25:1}
\aufgabenkopf{WiSe 2024/25 \textendash{} Aufgabe 1}{20 Punkte}{A1Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 682.50bp 39.00bp 106.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (339.36bp,-1.26bp) rectangle (367.92bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (168.84bp,-22.26bp) rectangle (204.94bp,-32.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (24.50bp,-34.02bp) rectangle (43.68bp,-44.10bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (78.12bp,-34.02bp) rectangle (102.48bp,-44.10bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\includegraphics[page=2,trim={52.00bp 490.50bp 39.00bp 192.50bp},clip,scale=0.620]{A_WiSe24y25.pdf}
\par\vspace{1.2mm}
\phantomsection\label{tf:WiSe24y25:1:1}
\par\vspace{1.6mm}
\Needspace*{38mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 390.50bp 39.00bp 424.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (283.92bp,-13.02bp) rectangle (309.12bp,-23.10bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (75.94bp,-1.26bp) rectangle (126.00bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (124.32bp,-1.26bp) rectangle (131.04bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A1Farbe}
\vspace{1.2mm}
\includegraphics[page=1,trim={52.00bp 626.50bp 39.00bp 130.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\end{loesung}
\par\vspace{1.6mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 325.50bp 39.00bp 489.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (207.48bp,-1.26bp) rectangle (237.51bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (269.64bp,-1.26bp) rectangle (299.88bp,-11.34bp);
\end{tikzpicture}
\par
\phantomsection\label{tf:WiSe24y25:1:2}
\Needspace*{18mm}
\verweis{A1Farbe}{2.}{Eindeutigkeit: bis zu welcher \gs{Frequenz} ist nur ein Wellentyp ausbreitungsfähig?}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{WiSe 2022/23, Aufgabe 1.2}, \textbf{Seite \pageref{tf:WiSe22x23:1:2}}}
\phantomsection\label{tf:WiSe24y25:1:3}
\Needspace*{18mm}
\verweis{A1Farbe}{3.}{\gs{Gesamtdämpfung in dB}: Leiterverluste \emph{plus} dielektrische Verluste}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{WiSe 2022/23, Aufgabe 1.3}, \textbf{Seite \pageref{tf:WiSe22x23:1:3}}}
\phantomsection\label{tf:WiSe24y25:1:4}
\par\vspace{1.6mm}
\Needspace*{40mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 174.50bp 39.00bp 641.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (124.02bp,-11.34bp) rectangle (149.82bp,-21.42bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (168.24bp,-11.34bp) rectangle (194.04bp,-21.42bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (240.60bp,-11.34bp) rectangle (258.36bp,-21.42bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (97.03bp,-1.26bp) rectangle (143.64bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (141.96bp,-1.26bp) rectangle (149.52bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A1Farbe}
\vspace{1.2mm}
\includegraphics[page=1,trim={52.00bp 250.50bp 39.00bp 554.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=1,trim={52.00bp 181.50bp 39.00bp 601.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\end{loesung}
\par\vspace{6mm}
\Needspace*{273.0mm}
...
\par\vspace{6mm}
\Needspace*{273.0mm}
\marke{\color{A1Farbe}A1 \textendash{} WiSe 2025/26}
\phantomsection\label{auf:WiSe25y26:1}
\aufgabenkopf{WiSe 2025/26 \textendash{} Aufgabe 1}{25 Punkte}{A1Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 643.50bp 39.00bp 106.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (231.00bp,-12.18bp) rectangle (252.58bp,-22.26bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (327.60bp,-33.18bp) rectangle (365.06bp,-43.26bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (41.72bp,-55.02bp) rectangle (63.00bp,-65.10bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (24.50bp,-66.78bp) rectangle (43.68bp,-76.86bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (78.12bp,-66.78bp) rectangle (102.48bp,-76.86bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\includegraphics[page=2,trim={52.00bp 432.50bp 39.00bp 230.50bp},clip,scale=0.620]{A_WiSe25y26.pdf}
\par\vspace{1.2mm}
\phantomsection\label{tf:WiSe25y26:1:1}
\Needspace*{18mm}
\verweis{A1Farbe}{1.}{Eindeutigkeit: bis zu welcher \gs{Frequenz} ist nur ein Wellentyp ausbreitungsfähig?}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{WiSe 2022/23, Aufgabe 1.2}, \textbf{Seite \pageref{tf:WiSe22x23:1:2}}}
\par\vspace{1.6mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 302.50bp 39.00bp 513.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (121.04bp,-1.26bp) rectangle (146.80bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (189.84bp,-1.26bp) rectangle (223.65bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (327.60bp,-1.26bp) rectangle (362.88bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (384.72bp,-1.26bp) rectangle (419.26bp,-11.34bp);
\end{tikzpicture}
\par
\phantomsection\label{tf:WiSe25y26:1:2}
\par\vspace{1.6mm}
\Needspace*{33mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 277.50bp 39.00bp 550.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (50.44bp,-1.26bp) rectangle (82.88bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A1Farbe}
\vspace{1.2mm}
\includegraphics[page=1,trim={52.00bp 610.50bp 39.00bp 219.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=1,trim={52.00bp 531.50bp 39.00bp 241.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\end{loesung}
\phantomsection\label{tf:WiSe25y26:1:3}
\par\vspace{1.6mm}
\Needspace*{43mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 226.50bp 39.00bp 589.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (67.96bp,-0.42bp) rectangle (91.87bp,-10.50bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A1Farbe}
\vspace{1.2mm}
\includegraphics[page=1,trim={52.00bp 375.50bp 39.00bp 358.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\end{loesung}
\par\vspace{1.6mm}
\includegraphics[page=2,trim={52.00bp 188.50bp 39.00bp 639.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}
\par
\phantomsection\label{tf:WiSe25y26:1:4}
\par\vspace{1.6mm}
\Needspace*{54mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 150.50bp 39.00bp 665.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (55.19bp,-0.42bp) rectangle (120.21bp,-10.50bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A1Farbe}
\vspace{1.2mm}
\includegraphics[page=1,trim={52.00bp 279.50bp 39.00bp 523.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=1,trim={52.00bp 155.50bp 39.00bp 572.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\end{loesung}
\phantomsection\label{tf:WiSe25y26:1:5}
\par\vspace{1.6mm}
\Needspace*{101mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=2,trim={52.00bp 86.50bp 39.00bp 715.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (108.02bp,-12.18bp) rectangle (125.16bp,-22.26bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (51.04bp,-1.26bp) rectangle (84.17bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A1Farbe}
\vspace{1.2mm}
\includegraphics[page=2,trim={52.00bp 741.50bp 39.00bp 57.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=2,trim={52.00bp 679.50bp 39.00bp 110.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=2,trim={52.00bp 634.50bp 39.00bp 196.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=2,trim={52.00bp 556.50bp 39.00bp 217.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=2,trim={52.00bp 520.50bp 39.00bp 310.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=2,trim={52.00bp 493.50bp 39.00bp 334.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=2,trim={52.00bp 389.50bp 39.00bp 360.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=2,trim={52.00bp 344.50bp 39.00bp 462.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\end{loesung}
\par\vspace{6mm}
\clearpage
...
{\sffamily\color{Grau} alle 11 Klausuren \textendash{} 23 verschiedene Teilaufgaben ausgeschrieben, 14 Wiederholungen als Verweis}\par\vspace{2mm}
...
Dielektrikum eingefüllt: ab welcher \gs{Frequenz} ausbreitungsfähig bzw. welches \gs{$\varepsilon_r$} ist dafür nötig? \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} Grundfall} & \textbf{S.\,\pageref{tf:WiSe22x23:2:3}} \textcolor{Grau}{WiSe 22/23, 3.} \\
Dielektrikum eingefüllt: ab welcher \gs{Frequenz} ausbreitungsfähig bzw. welches \gs{$\varepsilon_r$} ist dafür nötig? \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} hier nach $\varepsilon_r$ aufgelöst} & \textbf{S.\,\pageref{tf:WiSe24y25:2:3}} \textcolor{Grau}{WiSe 24/25, 3.} \\
...
\gs{Innenabmessungen $a$ und $b$} für einen vorgegebenen Frequenzbereich wählen \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} Grundfall} & \textbf{S.\,\pageref{tf:SoSe24:2:1}} \textcolor{Grau}{SoSe 24, 1.} \\
\gs{Innenabmessungen $a$ und $b$} für einen vorgegebenen Frequenzbereich wählen \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} hier muss der \emph{ganze} Bereich 6--10\,GHz eindeutig bleiben} & \textbf{S.\,\pageref{tf:WiSe24y25:2:1}} \textcolor{Grau}{WiSe 24/25, 1.} \\
\gs{Impuls- bzw. Gruppenlaufzeit} durch den Hohlleiter & \textbf{S.\,\pageref{tf:SoSe24:2:3}} \textcolor{Grau}{SoSe 24, 3.} \\
Rundhohlleiter: \gs{Mindestdurchmesser} für die $H_{01}$-Welle & \textbf{S.\,\pageref{tf:SoSe24:2:4}} \textcolor{Grau}{SoSe 24, 4.} \\
...
\sffamily\small
\begin{itemize}\setlength{\itemsep}{2.2mm}\setlength{\leftmargini}{4mm}
\item Rundhohlleiter: Mindestdurchmesser für den Grundwellentyp bzw. Eindeutigkeitsbereich des Rundhohlleiters \textcolor{Grau}{\itshape(bisher nur $H_{01}$: SoSe 24 A2.4)}\\[0.6mm] {\footnotesize\color{A2Farbe}$\rightarrow$ gleiche Bauart wie die $H_{01}$-Rechnung, nur mit der Konstante des jeweiligen Wellentyps -- FS 7.5 (Rundhohlleiter)}
...
\par\vspace{6mm}
\Needspace*{228.8mm}
\marke{\color{A2Farbe}A2 \textendash{} SoSe 2024}
\phantomsection\label{auf:SoSe24:2}
\aufgabenkopf{SoSe 2024 \textendash{} Aufgabe 2}{17 Punkte}{A2Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=3,trim={52.00bp 695.50bp 39.00bp 105.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (196.91bp,-2.10bp) rectangle (228.25bp,-12.18bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (24.72bp,-23.94bp) rectangle (48.72bp,-34.02bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\includegraphics[page=3,trim={52.00bp 578.50bp 39.00bp 168.50bp},clip,scale=0.620]{A_SoSe24.pdf}
\par\vspace{1.2mm}
\phantomsection\label{tf:SoSe24:2:1}
\par\vspace{1.6mm}
\Needspace*{41mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=3,trim={52.00bp 518.50bp 39.00bp 297.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (67.36bp,-1.26bp) rectangle (104.91bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A2Farbe}
\vspace{1.2mm}
\includegraphics[page=2,trim={52.00bp 657.50bp 39.00bp 86.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\par\vspace{1.6mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=3,trim={52.00bp 467.50bp 39.00bp 360.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (246.12bp,-1.26bp) rectangle (280.56bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (304.08bp,-1.26bp) rectangle (341.70bp,-11.34bp);
\end{tikzpicture}
\par
\phantomsection\label{tf:SoSe24:2:2}
\Needspace*{18mm}
\verweis{A2Farbe}{2.}{\gs{Dämpfung in dB} durch die \emph{Wandverluste} beim luftgefüllten Hohlleiter}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{WiSe 2022/23, Aufgabe 2.2}, \textbf{Seite \pageref{tf:WiSe22x23:2:2}}}
\phantomsection\label{tf:SoSe24:2:3}
\par\vspace{1.6mm}
\Needspace*{41mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=3,trim={52.00bp 366.50bp 39.00bp 449.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (227.92bp,-0.42bp) rectangle (244.16bp,-10.50bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (23.52bp,-11.34bp) rectangle (40.36bp,-21.42bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (111.79bp,-0.42bp) rectangle (159.52bp,-10.50bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A2Farbe}
\vspace{1.2mm}
\includegraphics[page=2,trim={52.00bp 379.50bp 39.00bp 449.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=2,trim={52.00bp 283.50bp 39.00bp 473.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\par\vspace{1.6mm}
\includegraphics[page=3,trim={52.00bp 315.50bp 39.00bp 498.50bp},clip,scale=0.840]{A_SoSe24.pdf}
\par
\par\vspace{1.6mm}
\includegraphics[page=3,trim={52.00bp 202.50bp 39.00bp 536.50bp},clip,scale=0.620]{A_SoSe24.pdf}
\par
\phantomsection\label{tf:SoSe24:2:4}
\par\vspace{1.6mm}
\Needspace*{34mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=3,trim={52.00bp 138.50bp 39.00bp 676.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (57.12bp,-1.26bp) rectangle (130.20bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (128.52bp,-1.26bp) rectangle (136.92bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
...
\begin{loesung}{A2Farbe}
\vspace{1.2mm}
\includegraphics[page=2,trim={52.00bp 160.50bp 39.00bp 611.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\par\vspace{6mm}
\Needspace*{178.2mm}
\marke{\color{A2Farbe}A2 \textendash{} WiSe 2024/25}
\phantomsection\label{auf:WiSe24y25:2}
\aufgabenkopf{WiSe 2024/25 \textendash{} Aufgabe 2}{21 Punkte}{A2Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=3,trim={52.00bp 708.50bp 39.00bp 105.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (202.45bp,-2.10bp) rectangle (228.20bp,-12.18bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (251.90bp,-2.10bp) rectangle (278.84bp,-12.18bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (181.44bp,-13.02bp) rectangle (214.57bp,-23.10bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\includegraphics[page=3,trim={52.00bp 569.50bp 39.00bp 177.50bp},clip,scale=0.620]{A_WiSe24y25.pdf}
\par\vspace{1.2mm}
\phantomsection\label{tf:WiSe24y25:2:1}
\par\vspace{1.6mm}
\Needspace*{50mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=3,trim={52.00bp 506.50bp 39.00bp 309.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (67.87bp,-1.26bp) rectangle (97.78bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A2Farbe}
\vspace{1.2mm}
\includegraphics[page=2,trim={52.00bp 636.50bp 39.00bp 86.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=2,trim={52.00bp 609.50bp 39.00bp 215.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\end{loesung}
\par\vspace{1.6mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=3,trim={52.00bp 455.50bp 39.00bp 372.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (246.12bp,-1.26bp) rectangle (281.82bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (316.49bp,-1.26bp) rectangle (342.25bp,-11.34bp);
\end{tikzpicture}
\par
\phantomsection\label{tf:WiSe24y25:2:2}
\Needspace*{18mm}
\verweis{A2Farbe}{2.}{\gs{Impuls- bzw. Gruppenlaufzeit} durch den Hohlleiter}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{SoSe 2024, Aufgabe 2.3}, \textbf{Seite \pageref{tf:SoSe24:2:3}}}
\par\vspace{1.6mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=3,trim={52.00bp 342.50bp 39.00bp 473.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (316.68bp,-1.26bp) rectangle (359.20bp,-11.34bp);
\end{tikzpicture}
\par
\phantomsection\label{tf:WiSe24y25:2:3}
\par\vspace{1.6mm}
\Needspace*{37mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=3,trim={52.00bp 290.50bp 39.00bp 525.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (90.76bp,-0.42bp) rectangle (163.42bp,-10.50bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A2Farbe}
\vspace{1.2mm}
\includegraphics[page=2,trim={52.00bp 318.50bp 39.00bp 442.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\end{loesung}
\phantomsection\label{tf:WiSe24y25:2:4}
\Needspace*{18mm}
\verweis{A2Farbe}{4.}{\gs{$\tan\delta$} aus der dielektrischen Dämpfung bzw. für ein Dämpfungs-Budget}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{WiSe 2022/23, Aufgabe 2.4}, \textbf{Seite \pageref{tf:WiSe22x23:2:4}}}
\par\vspace{6mm}
\Needspace*{191.2mm}
...
\par\vspace{6mm}
\Needspace*{76.4mm}
\marke{\color{A2Farbe}A2 \textendash{} WiSe 2025/26}
\phantomsection\label{auf:WiSe25y26:2}
\aufgabenkopf{WiSe 2025/26 \textendash{} Aufgabe 2}{17 Punkte}{A2Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=3,trim={52.00bp 695.50bp 39.00bp 106.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (352.80bp,-1.26bp) rectangle (387.07bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (14.07bp,-12.18bp) rectangle (39.69bp,-22.26bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (105.00bp,-12.18bp) rectangle (134.19bp,-22.26bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (128.88bp,-23.10bp) rectangle (152.88bp,-33.18bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\phantomsection\label{tf:WiSe25y26:2:1}
\Needspace*{18mm}
\verweis{A2Farbe}{1.}{\gs{Frequenzbereich}, in dem genau ein Wellentyp ausbreitungsfähig ist}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{WiSe 2020/21, Aufgabe 2.1}, \textbf{Seite \pageref{tf:WiSe20x21:2:1}}}
\phantomsection\label{tf:WiSe25y26:2:2}
\Needspace*{18mm}
\verweis{A2Farbe}{2.}{\gs{Dämpfung in dB} durch die \emph{Wandverluste} beim luftgefüllten Hohlleiter}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{WiSe 2022/23, Aufgabe 2.2}, \textbf{Seite \pageref{tf:WiSe22x23:2:2}}}
\phantomsection\label{tf:WiSe25y26:2:3}
\Needspace*{18mm}
\verweis{A2Farbe}{3.}{Hohlraumresonator: \gs{Mindestlänge} für eine Resonanzfrequenz}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{SoSe 2025, Aufgabe 2.3}, \textbf{Seite \pageref{tf:SoSe25:2:3}}}
\phantomsection\label{tf:WiSe25y26:2:4}
\Needspace*{18mm}
\verweis{A2Farbe}{4.}{Dielektrikum eingefüllt: ab welcher \gs{Frequenz} ausbreitungsfähig bzw. welches \gs{$\varepsilon_r$} ist dafür nötig?}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{WiSe 2024/25, Aufgabe 2.3}, \textbf{Seite \pageref{tf:WiSe24y25:2:3}}}
\par\vspace{1.6mm}
\includegraphics[page=3,trim={52.00bp 160.50bp 39.00bp 677.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}
\par
\par\vspace{6mm}
\clearpage
...
{\sffamily\color{Grau} alle 11 Klausuren \textendash{} 27 verschiedene Teilaufgaben ausgeschrieben, 8 Wiederholungen als Verweis}\par\vspace{2mm}
{\color{A3Farbe}\rule{\textwidth}{0.8pt}}\par\vspace{4mm}
{\sffamily\bfseries Register: Wenn gefragt wird \ldots}\hfill{\footnotesize\color{Grau}\colorbox{MarkerG!45}{grün} = das ist gesucht \textbf{·} rechts steht, wo die Aufgabe ausgeschrieben ist}\par\vspace{1.5mm}
\renewcommand{\arraystretch}{1.12}\footnotesize
\begin{tabularx}{\textwidth}{@{}>{\RaggedRight}X>{\RaggedRight\scriptsize}p{27mm}@{}}
\hline\rule{0pt}{3.5mm}
\gs{Beide Grenzwinkel} einer Anordnung: Totalreflexion ($P_d=0$) \emph{und} Brewster ($P_r=0$) \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} Grundfall} & \textbf{S.\,\pageref{tf:WiSe20x21:3:1}} \textcolor{Grau}{WiSe 20/21, 1.} \\
\gs{Beide Grenzwinkel} einer Anordnung: Totalreflexion ($P_d=0$) \emph{und} Brewster ($P_r=0$) \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} hier nur der Totalreflexions-Fall, dazu die Polarisation} & \textbf{S.\,\pageref{tf:SoSe24:3:3}} \textcolor{Grau}{SoSe 24, 3.} \\
...
Fresnel an \emph{einer} Grenzfläche: \gs{reflektierte und durchgehende Leistungsdichte} \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} hier nur der durchgehende Anteil} & \textbf{S.\,\pageref{tf:SoSe24:3:4}} \textcolor{Grau}{SoSe 24, 4.} \\
...
\gs{Effektivwerte von $E$ und $H$} aus der Leistungsdichte & \textbf{S.\,\pageref{tf:SoSe24:3:1}} \textcolor{Grau}{SoSe 24, 1.} \\
\gs{Einfallswinkel} \emph{und} \gs{Polarisationsrichtung} für reflexionsfreien Durchgang \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} Grundfall} & \textbf{S.\,\pageref{tf:SoSe24:3:2}} \textcolor{Grau}{SoSe 24, 2.} \\
...
\gs{Durchgehende Leistungsdichte} im reflexionsfreien Fall ($S_d = S_h\cos\alpha/\cos\beta$) & \textbf{S.\,\pageref{tf:WiSe24y25:3:2}} \textcolor{Grau}{WiSe 24/25, 2.} \\
Zirkular statt linear polarisiert: \gs{was ändert sich?} & \textbf{S.\,\pageref{tf:WiSe24y25:3:4}} \textcolor{Grau}{WiSe 24/25, 4.} \\
...
\par\vspace{6mm}
\Needspace*{269.2mm}
\marke{\color{A3Farbe}A3 \textendash{} SoSe 2024}
\phantomsection\label{auf:SoSe24:3}
\aufgabenkopf{SoSe 2024 \textendash{} Aufgabe 3}{22 Punkte}{A3Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=4,trim={52.00bp 707.50bp 39.00bp 107.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (221.58bp,-1.26bp) rectangle (245.97bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (222.66bp,-12.18bp) rectangle (241.47bp,-22.26bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (276.25bp,-12.18bp) rectangle (294.21bp,-22.26bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\includegraphics[page=4,trim={52.00bp 486.50bp 39.00bp 183.50bp},clip,scale=0.620]{A_SoSe24.pdf}
\par\vspace{1.2mm}
\phantomsection\label{tf:SoSe24:3:1}
\par\vspace{1.6mm}
\Needspace*{47mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=4,trim={52.00bp 403.50bp 39.00bp 412.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (92.02bp,-0.42bp) rectangle (143.18bp,-10.50bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A3Farbe}
\vspace{1.2mm}
\includegraphics[page=3,trim={52.00bp 626.50bp 39.00bp 91.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\phantomsection\label{tf:SoSe24:3:2}
\par\vspace{1.6mm}
\Needspace*{44mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=4,trim={52.00bp 352.50bp 39.00bp 463.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (72.66bp,-1.26bp) rectangle (127.26bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A3Farbe}
\vspace{1.2mm}
\includegraphics[page=3,trim={52.00bp 468.50bp 39.00bp 261.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\phantomsection\label{tf:SoSe24:3:3}
\par\vspace{1.6mm}
\Needspace*{29mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=4,trim={52.00bp 300.50bp 39.00bp 514.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (82.74bp,-1.26bp) rectangle (139.69bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A3Farbe}
\vspace{1.2mm}
\includegraphics[page=3,trim={52.00bp 430.50bp 39.00bp 398.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=3,trim={52.00bp 379.50bp 39.00bp 425.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\phantomsection\label{tf:SoSe24:3:4}
\par\vspace{1.6mm}
\Needspace*{72mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=4,trim={52.00bp 236.50bp 39.00bp 566.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (157.08bp,-1.26bp) rectangle (183.26bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (98.19bp,-1.26bp) rectangle (152.13bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A3Farbe}
\vspace{1.2mm}
\includegraphics[page=3,trim={52.00bp 121.50bp 39.00bp 513.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\par\vspace{6mm}
\Needspace*{227.3mm}
\marke{\color{A3Farbe}A3 \textendash{} WiSe 2024/25}
\phantomsection\label{auf:WiSe24y25:3}
\aufgabenkopf{WiSe 2024/25 \textendash{} Aufgabe 3}{20 Punkte}{A3Farbe}
\includegraphics[page=4,trim={52.00bp 423.50bp 39.00bp 107.50bp},clip,scale=0.620]{A_WiSe24y25.pdf}
\par\vspace{1.2mm}
\phantomsection\label{tf:WiSe24y25:3:1}
\Needspace*{18mm}
\verweis{A3Farbe}{1.}{\gs{$\varepsilon_r$} aus dem Brewsterwinkel (\glqq reflektiert rein linear polarisiert\grqq{} bzw. \glqq ohne Reflexionsverluste\grqq{})}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{SoSe 2023, Aufgabe 3.1}, \textbf{Seite \pageref{tf:SoSe23:3:1}}}
\par\vspace{1.6mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=4,trim={52.00bp 338.50bp 39.00bp 489.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (63.99bp,-1.26bp) rectangle (83.21bp,-11.34bp);
\end{tikzpicture}
\par
\phantomsection\label{tf:WiSe24y25:3:2}
\par\vspace{1.6mm}
\Needspace*{80mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=4,trim={52.00bp 287.50bp 39.00bp 527.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (213.62bp,-1.26bp) rectangle (226.15bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (108.05bp,-1.26bp) rectangle (124.42bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A3Farbe}
\vspace{1.2mm}
\includegraphics[page=3,trim={52.00bp 514.50bp 39.00bp 289.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=3,trim={52.00bp 450.50bp 39.00bp 337.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=3,trim={52.00bp 309.50bp 39.00bp 403.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=3,trim={52.00bp 266.50bp 39.00bp 542.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\end{loesung}
\par\vspace{1.6mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=4,trim={52.00bp 251.50bp 39.00bp 578.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (81.62bp,-0.42bp) rectangle (109.34bp,-10.50bp);
\end{tikzpicture}
\par
\phantomsection\label{tf:WiSe24y25:3:3}
\Needspace*{18mm}
\verweis{A3Farbe}{3.}{Zweite Grenzfläche im Prisma: erst der \gs{Winkel} über die Geometrie, dann die \gs{Leistungsdichten}}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{SoSe 2021, Aufgabe 3.2}, \textbf{Seite \pageref{tf:SoSe21:3:2}}}
\phantomsection\label{tf:WiSe24y25:3:4}
\par\vspace{1.6mm}
\Needspace*{20mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=4,trim={52.00bp 149.50bp 39.00bp 666.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (304.45bp,-1.26bp) rectangle (324.66bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A3Farbe}
\vspace{1.2mm}
\includegraphics[page=4,trim={52.00bp 493.50bp 39.00bp 334.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\end{loesung}
\par\vspace{6mm}
\Needspace*{249.6mm}
...
\par\vspace{6mm}
\Needspace*{55.0mm}
\marke{\color{A3Farbe}A3 \textendash{} WiSe 2025/26}
\phantomsection\label{auf:WiSe25y26:3}
\aufgabenkopf{WiSe 2025/26 \textendash{} Aufgabe 3}{19 Punkte}{A3Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=4,trim={52.00bp 707.50bp 39.00bp 106.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (233.52bp,-1.26bp) rectangle (270.90bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (117.60bp,-13.02bp) rectangle (152.09bp,-23.10bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (251.35bp,-13.02bp) rectangle (267.25bp,-23.10bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\phantomsection\label{tf:WiSe25y26:3:1}
\Needspace*{18mm}
\verweis{A3Farbe}{1.}{\gs{Einfallswinkel} \emph{und} \gs{Polarisationsrichtung} für reflexionsfreien Durchgang}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{SoSe 2024, Aufgabe 3.2}, \textbf{Seite \pageref{tf:SoSe24:3:2}}}
\phantomsection\label{tf:WiSe25y26:3:2}
\Needspace*{18mm}
\verweis{A3Farbe}{2.}{Zweite Grenzfläche im Prisma: erst der \gs{Winkel} über die Geometrie, dann die \gs{Leistungsdichten}}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{SoSe 2021, Aufgabe 3.2}, \textbf{Seite \pageref{tf:SoSe21:3:2}}}
\phantomsection\label{tf:WiSe25y26:3:3}
\Needspace*{18mm}
\verweis{A3Farbe}{3.}{\gs{Prismenwinkel} für reflexionsfreien \emph{Austritt} (Brewster von innen nach außen)}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{WiSe 2022/23, Aufgabe 3.4}, \textbf{Seite \pageref{tf:WiSe22x23:3:4}}}
\par\vspace{6mm}
\clearpage
...
{\sffamily\color{Grau} alle 11 Klausuren \textendash{} 23 verschiedene Teilaufgaben ausgeschrieben, 10 Wiederholungen als Verweis}\par\vspace{2mm}
...
\gs{Kompensationsbauteil} ($C$ oder $L$, seriell oder parallel) so wählen, dass die Impedanz \emph{rein reell} wird \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} hier in \emph{Serie} eingeschleift statt parallel, und ausdrücklich nach dem Bauteilewert gefragt} & \textbf{S.\,\pageref{tf:SoSe24:4:2}} \textcolor{Grau}{SoSe 24, 2.} \\
...
\gs{Impedanz} über eine Leitung nach vorn transformieren (Leitungsgleichung) \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} Grundfall} & \textbf{S.\,\pageref{tf:SoSe22:4:1}} \textcolor{Grau}{SoSe 22, 1.} \\
\gs{Impedanz} über eine Leitung nach vorn transformieren (Leitungsgleichung) \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} hier eine rein reelle Ausgangsimpedanz} & \textbf{S.\,\pageref{tf:WiSe24y25:4:3}} \textcolor{Grau}{WiSe 24/25, 3.} \\
\gs{Impedanz} über eine Leitung nach vorn transformieren (Leitungsgleichung) \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} hier liegt zwischen den beiden Leitungen noch die Spule $L$ in Serie} & \textbf{S.\,\pageref{tf:WiSe25y26:4:2}} \textcolor{Grau}{WiSe 25/26, 2.} \\
...
\gs{Impedanz} der Parallelschaltung zweier am Ende belasteter Leitungen & \textbf{S.\,\pageref{tf:SoSe24:4:1}} \textcolor{Grau}{SoSe 24, 1.} \\
Zweidrahtleitung: \gs{Mittenabstand $a$} der Drähte aus $Z_L$ & \textbf{S.\,\pageref{tf:SoSe24:4:4}} \textcolor{Grau}{SoSe 24, 4.} \\
...
\gs{Realteil} am Leitungsanfang, wenn die Last abgeklemmt wird (Leerlauf) & \textbf{S.\,\pageref{tf:WiSe25y26:4:3}} \textcolor{Grau}{WiSe 25/26, 3.} \\
\hline\end{tabularx}\normalsize
\par\vspace{5mm}
...
\item Koaxialleitung statt Zweidrahtleitung: Durchmesserverhältnis $D/d$ aus $Z_L$ -- Brücke zu Aufgabe 1 \textcolor{Grau}{\itshape(Zweidraht-Variante: SoSe 24 A4.4)}\\[0.6mm] {\footnotesize\color{A4Farbe}$\rightarrow$ $Z_L=\frac{60\,\Omega}{\sqrt{\varepsilon_r}}\ln\frac{D}{d}$ nach $D/d$ auflösen (statt der Zweidraht-Formel). K1}
\end{itemize}\end{tcolorbox}
\clearpage
\Needspace*{182.0mm}
...
\par\vspace{6mm}
\Needspace*{273.0mm}
\marke{\color{A4Farbe}A4 \textendash{} SoSe 2024}
\phantomsection\label{auf:SoSe24:4}
\aufgabenkopf{SoSe 2024 \textendash{} Aufgabe 4}{23 Punkte}{A4Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=5,trim={52.00bp 698.50bp 39.00bp 106.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (328.35bp,-12.18bp) rectangle (353.06bp,-22.26bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=5,trim={52.00bp 631.50bp 39.00bp 157.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (109.09bp,-1.26bp) rectangle (135.34bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (109.76bp,-12.18bp) rectangle (131.04bp,-22.26bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (109.20bp,-23.94bp) rectangle (132.72bp,-34.02bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (109.57bp,-34.02bp) rectangle (137.39bp,-44.10bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\includegraphics[page=5,trim={52.00bp 426.50bp 39.00bp 238.50bp},clip,scale=0.620]{A_SoSe24.pdf}
\par\vspace{1.2mm}
\phantomsection\label{tf:SoSe24:4:1}
\par\vspace{1.6mm}
\Needspace*{75mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=5,trim={52.00bp 340.50bp 39.00bp 475.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (54.02bp,-1.26bp) rectangle (94.92bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (92.40bp,-1.26bp) rectangle (99.12bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A4Farbe}
\vspace{1.2mm}
\includegraphics[page=4,trim={52.00bp 692.50bp 39.00bp 95.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=4,trim={52.00bp 616.50bp 39.00bp 159.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=4,trim={52.00bp 490.50bp 39.00bp 235.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\par\vspace{1.6mm}
\includegraphics[page=5,trim={52.00bp 301.50bp 39.00bp 526.50bp},clip,scale=0.840]{A_SoSe24.pdf}
\par
\phantomsection\label{tf:SoSe24:4:2}
\par\vspace{1.6mm}
\Needspace*{33mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=5,trim={52.00bp 251.50bp 39.00bp 564.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (70.08bp,-1.26bp) rectangle (106.68bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (104.16bp,-1.26bp) rectangle (111.72bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A4Farbe}
\vspace{1.2mm}
\includegraphics[page=4,trim={52.00bp 401.50bp 39.00bp 372.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\phantomsection\label{tf:SoSe24:4:3}
\Needspace*{18mm}
\verweis{A4Farbe}{3.}{$\lambda/4$-Transformator entwerfen: \gs{Länge $l$} und \gs{Wellenwiderstand $Z_L$} für ein gefordertes $Z$}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{WiSe 2022/23, Aufgabe 4.3}, \textbf{Seite \pageref{tf:WiSe22x23:4:3}}}
\phantomsection\label{tf:SoSe24:4:4}
\par\vspace{1.6mm}
\Needspace*{78mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=5,trim={52.00bp 124.50bp 39.00bp 678.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (229.32bp,-11.34bp) rectangle (265.44bp,-21.42bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (339.70bp,-1.26bp) rectangle (393.12bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (391.44bp,-1.26bp) rectangle (398.16bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A4Farbe}
\vspace{1.2mm}
\includegraphics[page=4,trim={52.00bp 222.50bp 39.00bp 540.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=4,trim={52.00bp 147.50bp 39.00bp 630.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=4,trim={52.00bp 44.50bp 39.00bp 706.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\par\vspace{6mm}
\Needspace*{140.4mm}
\marke{\color{A4Farbe}A4 \textendash{} WiSe 2024/25}
\phantomsection\label{auf:WiSe24y25:4}
\aufgabenkopf{WiSe 2024/25 \textendash{} Aufgabe 4}{19 Punkte}{A4Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=5,trim={52.00bp 646.50bp 39.00bp 106.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (225.92bp,-12.18bp) rectangle (250.77bp,-22.26bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (109.09bp,-33.18bp) rectangle (135.34bp,-43.26bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (109.05bp,-44.10bp) rectangle (147.15bp,-54.18bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (108.92bp,-55.02bp) rectangle (130.20bp,-65.10bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (106.68bp,-66.78bp) rectangle (125.16bp,-76.86bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\includegraphics[page=5,trim={52.00bp 525.50bp 39.00bp 224.50bp},clip,scale=0.620]{A_WiSe24y25.pdf}
\par\vspace{1.2mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=5,trim={52.00bp 495.50bp 39.00bp 321.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (167.16bp,-9.66bp) rectangle (211.68bp,-20.58bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (315.00bp,-9.66bp) rectangle (346.92bp,-20.58bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\phantomsection\label{tf:WiSe24y25:4:1}
\Needspace*{18mm}
\verweis{A4Farbe}{1.}{\gs{Impedanz} über eine Leitung nach vorn transformieren (Leitungsgleichung)}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{SoSe 2022, Aufgabe 4.1}, \textbf{Seite \pageref{tf:SoSe22:4:1}}}
\phantomsection\label{tf:WiSe24y25:4:2}
\Needspace*{18mm}
\verweis{A4Farbe}{2.}{\gs{Kompensationsbauteil} ($C$ oder $L$, seriell oder parallel) so wählen, dass die Impedanz \emph{rein reell} wird}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{SoSe 2021, Aufgabe 4.1}, \textbf{Seite \pageref{tf:SoSe21:4:1}}}
\phantomsection\label{tf:WiSe24y25:4:3}
\par\vspace{1.6mm}
\Needspace*{31mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=5,trim={52.00bp 288.50bp 39.00bp 539.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (128.52bp,-1.26bp) rectangle (163.15bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (373.27bp,-1.26bp) rectangle (397.40bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A4Farbe}
\vspace{1.2mm}
\includegraphics[page=5,trim={52.00bp 377.50bp 39.00bp 391.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\end{loesung}
\phantomsection\label{tf:WiSe24y25:4:4}
\Needspace*{18mm}
\verweis{A4Farbe}{4.}{$\lambda/4$-Transformator entwerfen: \gs{Länge $l$} und \gs{Wellenwiderstand $Z_L$} für ein gefordertes $Z$}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{WiSe 2022/23, Aufgabe 4.3}, \textbf{Seite \pageref{tf:WiSe22x23:4:3}}}
\par\vspace{6mm}
\Needspace*{232.8mm}
...
\par\vspace{6mm}
\Needspace*{189.9mm}
\marke{\color{A4Farbe}A4 \textendash{} WiSe 2025/26}
\phantomsection\label{auf:WiSe25y26:4}
\aufgabenkopf{WiSe 2025/26 \textendash{} Aufgabe 4}{20 Punkte}{A4Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=5,trim={52.00bp 605.50bp 39.00bp 119.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (269.43bp,-11.34bp) rectangle (294.03bp,-21.42bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (49.45bp,-33.18bp) rectangle (75.70bp,-43.26bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (49.45bp,-43.26bp) rectangle (75.70bp,-53.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (52.64bp,-55.02bp) rectangle (73.92bp,-65.10bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (52.64bp,-65.94bp) rectangle (73.92bp,-76.02bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (38.64bp,-76.86bp) rectangle (75.70bp,-86.94bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\includegraphics[page=5,trim={52.00bp 414.50bp 39.00bp 270.50bp},clip,scale=0.620]{A_WiSe25y26.pdf}
\par\vspace{1.2mm}
\phantomsection\label{tf:WiSe25y26:4:1}
\Needspace*{18mm}
\verweis{A4Farbe}{1.}{\gs{Kompensationsbauteil} ($C$ oder $L$, seriell oder parallel) so wählen, dass die Impedanz \emph{rein reell} wird}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{SoSe 2021, Aufgabe 4.1}, \textbf{Seite \pageref{tf:SoSe21:4:1}}}
\phantomsection\label{tf:WiSe25y26:4:2}
\par\vspace{1.6mm}
\Needspace*{64mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=5,trim={52.00bp 275.50bp 39.00bp 539.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (237.72bp,-12.18bp) rectangle (273.84bp,-22.26bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (97.44bp,-1.26bp) rectangle (115.55bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A4Farbe}
\vspace{1.2mm}
\includegraphics[page=5,trim={52.00bp 223.50bp 39.00bp 429.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\end{loesung}
\phantomsection\label{tf:WiSe25y26:4:3}
\par\vspace{1.6mm}
\Needspace*{25mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=5,trim={52.00bp 212.50bp 39.00bp 603.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (53.28bp,-1.26bp) rectangle (84.72bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A4Farbe}
\vspace{1.2mm}
\includegraphics[page=5,trim={52.00bp 113.50bp 39.00bp 695.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\end{loesung}
\par\vspace{6mm}
\clearpage
...
{\sffamily\color{Grau} alle 11 Klausuren \textendash{} 31 verschiedene Teilaufgaben ausgeschrieben, 8 Wiederholungen als Verweis}\par\vspace{2mm}
...
\gs{Empfangsleistung} aus Leistungsdichte und Gewinn (über die Wirkfläche $A_W$) \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} Grundfall} & \textbf{S.\,\pageref{tf:WiSe22x23:5:3}} \textcolor{Grau}{WiSe 22/23, 3.} \\
\gs{Empfangsleistung} aus Leistungsdichte und Gewinn (über die Wirkfläche $A_W$) \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} Ergebnis in dBm} & \textbf{S.\,\pageref{tf:SoSe24:5:4}} \textcolor{Grau}{SoSe 24, 4.} \\
\gs{Verhältnis zweier Empfangsleistungen} in dB & \textbf{S.\,\pageref{tf:WiSe22x23:5:4}} \textcolor{Grau}{WiSe 22/23, 4.} \\
\gs{Phasenunterschied} für eine gewünschte Hauptstrahlrichtung \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} Grundfall} & \textbf{S.\,\pageref{tf:SoSe23:5:1}} \textcolor{Grau}{SoSe 23, 1.} \\
\gs{Phasenunterschied} für eine gewünschte Hauptstrahlrichtung \newline \hspace*{3mm}\textcolor{Grau}{\itshape \textendash{} der Winkel kommt hier erst aus der Geometrie $h$/$R$} & \textbf{S.\,\pageref{tf:WiSe25y26:5:4}} \textcolor{Grau}{WiSe 25/26, 4.} \\
\gs{Empfangsleistungen} mehrerer Antennengruppen an demselben Ort & \textbf{S.\,\pageref{tf:SoSe23:5:4}} \textcolor{Grau}{SoSe 23, 4.} \\
\gs{Antennengewinn} aus der Fläche einer Parabolantenne & \textbf{S.\,\pageref{tf:SoSe24:5:1}} \textcolor{Grau}{SoSe 24, 1.} \\
Radar: \gs{Leistungsdichte} des vom Ziel zurückgestreuten Signals & \textbf{S.\,\pageref{tf:SoSe24:5:3}} \textcolor{Grau}{SoSe 24, 3.} \\
Radar mit Zusatzdämpfung: welche \gs{Entfernung} ist noch möglich? & \textbf{S.\,\pageref{tf:SoSe24:5:5}} \textcolor{Grau}{SoSe 24, 5.} \\
\gs{Durchmesser} der Parabolantenne aus der geforderten Empfangsleistung & \textbf{S.\,\pageref{tf:WiSe24y25:5:3}} \textcolor{Grau}{WiSe 24/25, 3.} \\
\gs{Anzahl der Dipole} aus dem Gewinn \emph{und} \gs{Länge der Antennenzeile} & \textbf{S.\,\pageref{tf:WiSe24y25:5:4}} \textcolor{Grau}{WiSe 24/25, 4.} \\
Frequenzwechsel: um wieviel \gs{dB} ändert sich die Empfangsleistung? & \textbf{S.\,\pageref{tf:SoSe25:5:4}} \textcolor{Grau}{SoSe 25, 4.} \\
\gs{Gewinn} der Gruppenantenne unter einem bestimmten Winkel (in dBi) & \textbf{S.\,\pageref{tf:WiSe25y26:5:3}} \textcolor{Grau}{WiSe 25/26, 3.} \\
\hline\end{tabularx}\normalsize
\par\vspace{5mm}
...
\item Umkehrung der Phasensteuerung: Schwenkwinkel der Hauptstrahlrichtung aus gegebenem Phasenunterschied $\Delta\varphi$ \textcolor{Grau}{\itshape(Hinrichtung: WiSe 25/26 A5.4)}\\[0.6mm] {\footnotesize\color{A5Farbe}$\rightarrow$ $u=\delta+\frac{2\pi}{\lambda_0}b\cos\vartheta$; Hauptkeule liegt bei $u=0$, also nach $\vartheta$ auflösen. FS 8.7}
...
\item Zusätzliche Streckendämpfung in dB (Regen, Wand, Kabel zwischen Sender und Antenne) $\rightarrow$ Reichweite \textcolor{Grau}{\itshape(Radar-Variante: SoSe 24 A5.5)}\\[0.6mm] {\footnotesize\color{A5Farbe}$\rightarrow$ Dämpfung in der dBm-Bilanz abziehen; für die Reichweite gilt $S\sim1/r^2$, also $r_{neu}=r_{alt}\cdot10^{-a_{dB}/20}$}
\item Wieviele Halbwellendipole braucht man für den Gewinn einer Parabolantenne? Und wie lang wird die Gruppe? \textcolor{Grau}{\itshape(so gestellt in WiSe 24/25 A5.4)}\\[0.6mm] {\footnotesize\color{A5Farbe}$\rightarrow$ $g$ der Parabolantenne aus $A_W$; $N=g_{ges}/g_{Einzel}$ (bzw.\ $+3$\,dB je Verdopplung), Länge $=(N-1)\cdot b$}
...
\par\vspace{6mm}
\Needspace*{263.8mm}
\marke{\color{A5Farbe}A5 \textendash{} SoSe 2024}
\phantomsection\label{auf:SoSe24:5}
\aufgabenkopf{SoSe 2024 \textendash{} Aufgabe 5}{20 Punkte}{A5Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=6,trim={52.00bp 671.50bp 39.00bp 106.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (396.46bp,-1.26bp) rectangle (413.61bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (329.94bp,-12.18bp) rectangle (351.38bp,-22.26bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (5.88bp,-22.26bp) rectangle (28.38bp,-32.34bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\includegraphics[page=6,trim={52.00bp 553.50bp 39.00bp 211.50bp},clip,scale=0.620]{A_SoSe24.pdf}
\par\vspace{1.2mm}
\phantomsection\label{tf:SoSe24:5:1}
\par\vspace{1.6mm}
\Needspace*{41mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=6,trim={52.00bp 469.50bp 39.00bp 358.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (60.09bp,-1.26bp) rectangle (124.32bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (122.64bp,-1.26bp) rectangle (129.36bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A5Farbe}
\vspace{1.2mm}
\includegraphics[page=5,trim={52.00bp 633.50bp 39.00bp 94.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\phantomsection\label{tf:SoSe24:5:2}
\Needspace*{18mm}
\verweis{A5Farbe}{2.}{\gs{Leistungsdichte} $S = G\,P/(4\pi r^2)$ am Empfangsort}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{SoSe 2022, Aufgabe 5.1}, \textbf{Seite \pageref{tf:SoSe22:5:1}}}
\par\vspace{1.6mm}
\includegraphics[page=6,trim={52.00bp 349.50bp 39.00bp 453.50bp},clip,scale=0.840]{A_SoSe24.pdf}
\par
\phantomsection\label{tf:SoSe24:5:3}
\par\vspace{1.6mm}
\Needspace*{41mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=6,trim={52.00bp 299.50bp 39.00bp 503.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (240.49bp,-1.26bp) rectangle (257.37bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (204.12bp,-23.10bp) rectangle (248.32bp,-33.18bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (51.39bp,-1.26bp) rectangle (116.76bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (115.08bp,-1.26bp) rectangle (121.80bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
...
\begin{loesung}{A5Farbe}
\vspace{1.2mm}
\includegraphics[page=5,trim={52.00bp 449.50bp 39.00bp 310.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\phantomsection\label{tf:SoSe24:5:4}
\par\vspace{1.6mm}
\Needspace*{46mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=6,trim={52.00bp 248.50bp 39.00bp 567.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (204.12bp,-11.34bp) rectangle (247.80bp,-21.42bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (52.18bp,-1.26bp) rectangle (90.72bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (89.04bp,-1.26bp) rectangle (96.60bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A5Farbe}
\vspace{1.2mm}
\includegraphics[page=5,trim={52.00bp 377.50bp 39.00bp 424.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=5,trim={52.00bp 290.50bp 39.00bp 474.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\phantomsection\label{tf:SoSe24:5:5}
\par\vspace{1.6mm}
\Needspace*{42mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=6,trim={52.00bp 185.50bp 39.00bp 617.50bp},clip,scale=0.840]{A_SoSe24.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (299.41bp,-1.26bp) rectangle (317.08bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (65.49bp,-12.18bp) rectangle (105.33bp,-22.26bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A5Farbe}
\vspace{1.2mm}
\includegraphics[page=5,trim={52.00bp 252.50bp 39.00bp 575.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=5,trim={52.00bp 164.50bp 39.00bp 603.50bp},clip,scale=0.700]{L_SoSe24.pdf}
\par
\end{loesung}
\par\vspace{6mm}
\Needspace*{235.1mm}
\marke{\color{A5Farbe}A5 \textendash{} WiSe 2024/25}
\phantomsection\label{auf:WiSe24y25:5}
\aufgabenkopf{WiSe 2024/25 \textendash{} Aufgabe 5}{20 Punkte}{A5Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=6,trim={52.00bp 666.50bp 39.00bp 106.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (78.22bp,-27.30bp) rectangle (105.73bp,-37.38bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (74.85bp,-38.22bp) rectangle (106.59bp,-48.30bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (129.36bp,-49.14bp) rectangle (168.10bp,-59.22bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\includegraphics[page=6,trim={52.00bp 621.50bp 39.00bp 194.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}
\par\vspace{1.2mm}
\includegraphics[page=6,trim={52.00bp 416.50bp 39.00bp 256.50bp},clip,scale=0.620]{A_WiSe24y25.pdf}
\par\vspace{1.2mm}
\phantomsection\label{tf:WiSe24y25:5:1}
\Needspace*{18mm}
\verweis{A5Farbe}{1.}{\gs{Antennengewinn} aus der Fläche einer Parabolantenne}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{SoSe 2024, Aufgabe 5.1}, \textbf{Seite \pageref{tf:SoSe24:5:1}}}
\phantomsection\label{tf:WiSe24y25:5:2}
\Needspace*{18mm}
\verweis{A5Farbe}{2.}{\gs{Leistungsdichte} $S = G\,P/(4\pi r^2)$ am Empfangsort}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{SoSe 2022, Aufgabe 5.1}, \textbf{Seite \pageref{tf:SoSe22:5:1}}}
\phantomsection\label{tf:WiSe24y25:5:3}
\par\vspace{1.6mm}
\Needspace*{47mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=6,trim={52.00bp 230.50bp 39.00bp 572.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (245.28bp,-1.26bp) rectangle (284.05bp,-11.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (73.84bp,-22.26bp) rectangle (104.36bp,-32.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (58.13bp,-11.34bp) rectangle (111.72bp,-21.42bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (110.04bp,-11.34bp) rectangle (116.76bp,-21.42bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A5Farbe}
\vspace{1.2mm}
\includegraphics[page=6,trim={52.00bp 429.50bp 39.00bp 310.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=6,trim={52.00bp 396.50bp 39.00bp 439.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\end{loesung}
\phantomsection\label{tf:WiSe24y25:5:4}
\par\vspace{1.6mm}
\Needspace*{71mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=6,trim={52.00bp 90.50bp 39.00bp 648.50bp},clip,scale=0.840]{A_WiSe24y25.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (35.78bp,-76.02bp) rectangle (60.65bp,-86.10bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (82.32bp,-1.26bp) rectangle (154.56bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A5Farbe}
\vspace{1.2mm}
\includegraphics[page=6,trim={52.00bp 342.50bp 39.00bp 444.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=6,trim={52.00bp 261.50bp 39.00bp 509.50bp},clip,scale=0.700]{L_WiSe24y25.pdf}
\par
\end{loesung}
\par\vspace{6mm}
\Needspace*{273.0mm}
...
\par\vspace{6mm}
\Needspace*{259.0mm}
\marke{\color{A5Farbe}A5 \textendash{} WiSe 2025/26}
\phantomsection\label{auf:WiSe25y26:5}
\aufgabenkopf{WiSe 2025/26 \textendash{} Aufgabe 5}{19 Punkte}{A5Farbe}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=6,trim={52.00bp 695.50bp 39.00bp 106.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (158.34bp,-22.26bp) rectangle (190.26bp,-32.34bp);
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (278.88bp,-22.26bp) rectangle (302.16bp,-32.34bp);
\end{tikzpicture}
\par\vspace{1.2mm}
\includegraphics[page=6,trim={52.00bp 351.50bp 39.00bp 172.50bp},clip,scale=0.620]{A_WiSe25y26.pdf}
\par\vspace{1.2mm}
\phantomsection\label{tf:WiSe25y26:5:1}
\Needspace*{18mm}
\verweis{A5Farbe}{1.}{\gs{Gewinn} einer Dipolzeile / Dipol-Linie in dBi}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{WiSe 2022/23, Aufgabe 5.1}, \textbf{Seite \pageref{tf:WiSe22x23:5:1}}}
\phantomsection\label{tf:WiSe25y26:5:2}
\Needspace*{18mm}
\verweis{A5Farbe}{2.}{\gs{Empfangsleistung} aus Leistungsdichte und Gewinn (über die Wirkfläche $A_W$)}{gleiche Frage, nur andere Zahlenwerte \textendash{} siehe \textbf{WiSe 2022/23, Aufgabe 5.3}, \textbf{Seite \pageref{tf:WiSe22x23:5:3}}}
\phantomsection\label{tf:WiSe25y26:5:3}
\par\vspace{1.6mm}
\Needspace*{51mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=6,trim={52.00bp 149.50bp 39.00bp 678.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (276.36bp,-1.26bp) rectangle (304.19bp,-11.34bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (90.09bp,-1.26bp) rectangle (115.26bp,-11.34bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A5Farbe}
\vspace{1.2mm}
\includegraphics[page=6,trim={52.00bp 375.50bp 39.00bp 314.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\end{loesung}
\phantomsection\label{tf:WiSe25y26:5:4}
\par\vspace{1.6mm}
\Needspace*{80mm}
\begin{tikzpicture}[inner sep=0]
\node[anchor=north west,inner sep=0] (bi) at (0,0) {\includegraphics[page=6,trim={52.00bp 72.50bp 39.00bp 730.50bp},clip,scale=0.840]{A_WiSe25y26.pdf}};
\fill[Marker,opacity=0.30,rounded corners=0.6bp] (82.67bp,-11.34bp) rectangle (106.58bp,-21.42bp);
\fill[MarkerG,opacity=0.30,rounded corners=0.6bp] (69.22bp,-0.42bp) rectangle (135.63bp,-10.50bp);
\end{tikzpicture}
\par\nopagebreak
\vspace{0.8mm}\nopagebreak
\begin{loesung}{A5Farbe}
\vspace{1.2mm}
\includegraphics[page=6,trim={52.00bp 200.50bp 39.00bp 511.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\par\vspace{1.0mm}
\includegraphics[page=6,trim={52.00bp 79.50bp 39.00bp 651.50bp},clip,scale=0.700]{L_WiSe25y26.pdf}
\par
\end{loesung}
\par\vspace{6mm}
\end{document}