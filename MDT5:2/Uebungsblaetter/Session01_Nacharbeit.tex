...
\end{tabular}
\end{center}
{\footnotesize $^{*}$ f-AnoGAN und VAE auf der Folie als gestrichelte Kästen \emph{über beiden Spalten} Probabilistisch/Rekonstruktion -- genauso zeichnen. Klammern wie auf der Folie.}
