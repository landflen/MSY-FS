...
\begin{itemize}
  ...
  \item \stolper PCA \& k-Means zählen als \textbf{Rekonstruktion} (Projektions-/Zentrumsfehler als Score) -- beide sind aber \textbf{geklammert $\to$ nicht klausurrelevant}, nur zur Einordnung merken.
\end{itemize}
