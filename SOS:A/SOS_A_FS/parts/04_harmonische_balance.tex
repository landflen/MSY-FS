...
{\scriptsize\textbf{Schnittpunkt} $G(j\omega_0){=}-\tfrac1{K_N(v_0)}$:\;
$\omega_0$ an $G$-Kurve,\; $v_0$ an $-1/K_N$-Kurve ablesen;\; $T_0{=}\tfrac{2\pi}{\omega_0}$.}
\end{minipage}\hfill
\begin{minipage}[c]{0.44\linewidth}\centering
...
\textit{ohne Gedächtnis $\Rightarrow K_N\in\mathbb{R}$ (reelle Achse); mit Gedächtnis $\Rightarrow K_N\in\mathbb{C}$.}
