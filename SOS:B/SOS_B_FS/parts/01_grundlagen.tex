...
% ==========================================================
%  REZEPTE — WDF / Transformation / EW · Varianz / Summe
% ==========================================================

\bereich[cGrundl]{REZEPT A1 · Gültige WDF / Normierung (+ Mittelwertfreiheit)}
\begin{rezept}
...
\miniexample{Normierung (a) \;/\; Normierung + Mittelwertfreiheit (b)}{%
  (a) $2{\cdot}\tfrac13+6\,f_0=1\Rightarrow f_0=\tfrac1{18}$.\hfill
  (b) $3f_1{+}9f_2{=}1$ und $\mu_X{=}0:\;-f_1\tfrac92+f_2\tfrac{81}2=0$
  $\Rightarrow f_1{=}\tfrac14,\;f_2{=}\tfrac1{36}$.}
\bereichende

\bereich[cGrundl]{REZEPT A2 · Transformation über Kennlinie $f_Y(y)=\dfrac{f_X(x)}{|g'(x)|}$}
\begin{rezept}
...
\miniexample{stückw.\ lineare Kennlinie \;/\; Kennlinie $g(x){=}\sqrt[3]{x}$}{%
  $g'{=}3\,(x{<}0),\,2\,(x{>}0)\Rightarrow
  f_Y{=}\tfrac{1/3}{3}{=}\tfrac19\,(-6{<}y{<}0),\;\tfrac{1/18}{2}{=}\tfrac1{36}\,(0{<}y{<}12)$.\\
  $g{=}\sqrt[3]{x}:\;g'{=}\tfrac{1}{3x^{2/3}}$, $x{=}y^3\Rightarrow f_Y(y)=f_X(y^3)\cdot 3y^2$.}
\bereichende

\bereich[cGrundl]{REZEPT A3 · Erwartungswert \& Varianz}
\begin{formelreihe}
  \parbox[t]{\linewidth}{%
...
\end{formelreihe}
\miniexample{$f_Y{=}\tfrac19$ auf $[-6,0]$, $\tfrac1{36}$ auf $[0,12]$}{%
  $\mu_Y=\tfrac19\!\int_{-6}^{0}\!y\,\mathrm dy+\tfrac1{36}\!\int_{0}^{12}\!y\,\mathrm dy
  =-2+2=0$;\quad
  $\sigma_Y^2=\tfrac19\!\int_{-6}^{0}\!y^2\mathrm dy+\tfrac1{36}\!\int_{0}^{12}\!y^2\mathrm dy
  =8+16=24$.}
\bereichende

\bereich[cGrundl]{REZEPT A4 · Summe $Z{=}X{+}Y$ über Faltung}
\noindent\footnotesize
$\mu_Z=\mu_X+\mu_Y$,\;\; $\sigma_Z^2=\sigma_X^2+\sigma_Y^2$ (unabh.),\;\;
$f_Z=f_X*f_Y$.
\begin{rezept}
  \rs{Verstärkung \emph{vor} der Summe zuerst transformieren ($Y{=}aX$:
      Dichte um $a$ stauchen/spiegeln, A2).}
...
\miniexample{diskret${+}$kontinuierlich \;/\; mit Verstärkung}{%
  $X\in\{\pm1\}$, $P({+}1){=}\tfrac23$, $Y\sim\mathcal U[0,4]$ ($f_Y{=}\tfrac14$):\;
  $f_Z=\tfrac13{\cdot}\tfrac14$ auf $[-1,3]\;+\;\tfrac23{\cdot}\tfrac14$ auf $[1,5]$
  (Überlapp $[1,3]:\tfrac1{12}{+}\tfrac16{=}\tfrac14$).\\
  $Z{=}{-}3X{+}Y$, $Y$ zwei Diracs bei $\pm2\Rightarrow
  f_Z=\tfrac12 f_{-3X}(z{-}2)+\tfrac12 f_{-3X}(z{+}2)$ (zwei verschobene Kopien).}
\bereichende
