...
% ============================================================
\teilkopf{3}{Teil 3 · Diskrete Zufallsprozesse (Ensemble, WSS, DTFT)}
...
\begin{formelreihe}
  ...
  \infoblock{\textbf{Wichtig:} zeitdiskret $\neq$ wertdiskret (Werte kontinu.).\\[0.15em]
    Ensemble \& Musterfkt.: wie bei kont.\ Prozessen.} &
...
\end{formelreihe}
\miniexample{$N{=}4$ Realisierungen, $x_i[1]{=}\{2,{-}2,2,{-}2\}$, $x_i[2]{=}\{1,{-}1,3,{-}3\}$}{%
  $q_X[1]=\sqrt{\tfrac14(2^2{+}2^2{+}2^2{+}2^2)}=2$;\quad
  $\varphi_{XX}[1,2]=\tfrac14\bigl(2{\cdot}1+({-}2)({-}1)+2{\cdot}3+({-}2)({-}3)\bigr)=4$.}
\bereichende
...
\begin{formelreihe}
  \infoblock{\textbf{i.i.d.\ Rauschen:} Werte unabh.\ \& gleichverteilt\\
    (independent identically distributed).\\[0.15em]
    $\Rightarrow$ stets stationär \& weiß.} &
