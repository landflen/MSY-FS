...
\miniexample{Redundante Messung (statisch): $y_i=x+n_i$, $\hat x=k_1y_1+k_2y_2$}{%
  Erwartungstreue $\Rightarrow k_1+k_2=1$;\quad
  $k_1=\dfrac{\sigma_{n_2}^2}{\sigma_{n_1}^2+\sigma_{n_2}^2}$,\quad
  $k_2=\dfrac{\sigma_{n_1}^2}{\sigma_{n_1}^2+\sigma_{n_2}^2}$\quad
  (kleinere Rauschvarianz $\to$ größeres Gewicht).}
\bereichende
...
\miniexample{Skalar, ohne Innovation ($A{=}0{,}8$, $C{=}1$, $G{=}0{,}2$, $Z_0{=}3$, $N_0{=}2$)}{%
  ...
  $\Rightarrow f_\infty^2+0{,}6f_\infty-0{,}24{=}0$, $f_\infty{=}0{,}275$,
  $K_\infty{=}\frac{0{,}8\cdot0{,}275}{2+0{,}275}{=}0{,}097$.}
